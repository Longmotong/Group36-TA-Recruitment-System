...
public class JobDetailPanel extends JPanel {
    ...
    private JScrollPane buildScrollBody() {
        ...
        hideVerticalScrollbarButKeepScroll(sp);
        sp.getVerticalScrollBar().setUnitIncrement(16);
        return sp;
    }

    /**
     * Keep wheel/trackpad scrolling while removing right-side scrollbar footprint,
     * so default window layout stays visually symmetric.
     */
    private static void hideVerticalScrollbarButKeepScroll(JScrollPane sp) {
        JScrollBar v = sp.getVerticalScrollBar();
        v.setPreferredSize(new Dimension(0, 0));
    ...
    private JPanel statusPillHero(String normalized) {
        ...
        pill.setBorder(new EmptyBorder(7, 14, 7, 14));
