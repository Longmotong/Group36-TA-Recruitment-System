...
public class Page_MyApplications {
    ...
    private void buildTable() {
        ...
        for (int i = 0; i < columns.length; i++) {
            ...
            if (i == 0) {
                ...
                col.setCellRenderer(new MyApplicationsRenderers.StatusBadgeRenderer());
            } else if (i == 6) {
                col.setCellRenderer(new MyApplicationsRenderers.ViewLinkRenderer());
            } else if (i == 7) {
                col.setCellRenderer(new MyApplicationsRenderers.CancelButtonRenderer());
            } else {
    ...
    private void buildDraftsTable() {
        ...
        for (int i = 0; i < columns.length; i++) {
            ...
            if (i == 5) {
                col.setCellRenderer(new MyApplicationsRenderers.DraftActionRenderer());
            } else if (i == 6) {
                col.setCellRenderer(new MyApplicationsRenderers.DraftDeleteRenderer());
            } else {
                col.setCellRenderer(leftRenderer);
            }
        }
