...
import MO_system.service.MoDashboardService;
...
/**
 * MO Dashboard — soft-neo layout aligned with the TA job portal palette; metrics from {@code data/}.
 */
public class MoDashboardPanel extends JPanel {
    ...
    private enum ModuleCardStyle {
        JOB_MANAGEMENT(
                JobsPortalUi.PRIMARY_PURPLE,
                JobsPortalUi.LAVENDER,
                JobsPortalUi.LIGHT_PURPLE_BORDER
        ),
        APPLICATION_REVIEW(
                JobsPortalUi.TEAL_ACCENT,
                JobsPortalUi.LAVENDER,
                JobsPortalUi.LIGHT_PURPLE_BORDER
        );
    ...
    private JPanel welcomeBanner() {
        ...
        banner.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createCompoundBorder(
                        BorderFactory.createMatteBorder(0, 4, 0, 0, JobsPortalUi.PRIMARY_PURPLE),
        ...
        JLabel title = new JLabel("<html><span style='color:#111033;font-size:30px;font-weight:700'>MO Dashboard</span></html>");
        title.setAlignmentX(Component.LEFT_ALIGNMENT);

        JLabel sub = new JLabel("<html><div style='width:720px;line-height:1.5'><span style='color:#667085;font-size:15px'>"
    ...
    private JPanel moduleCard(String title,
        ...
        introL.setForeground(JobsPortalUi.MUTED_TEXT);
        titles.add(t);
        ...
        JButton btn = MoUiTheme.portalGradientPrimary(cta, new Font(Font.SANS_SERIF, Font.BOLD, 13));
    ...
    private JPanel quickOverviewPanel() {
        ...
        metricTotal = new JLabel(String.valueOf(m.totalJobPostings()), SwingConstants.CENTER);
        ...
        Color statBg = JobsPortalUi.LAVENDER;
        Color statBorder = JobsPortalUi.LIGHT_PURPLE_BORDER;
        Color statValue = JobsPortalUi.DARK_TEXT;
        grid.add(statBox(metricTotal, "Total Job Postings", statBg, statBorder, statValue));
    ...
    private void refreshMetrics() {
        ...
        if (metricTotal != null) {
            metricTotal.setText(String.valueOf(m.totalJobPostings()));
