...
import MO_system.util.RelevantSkillsDeserializer;
...
public class ApplicationItem {
    ...
    public static class Workflow {
        ...
        public String getAssignedMO() {
            return assignedMO;
        }

        public void setAssignedMO(String assignedMO) {
            this.assignedMO = assignedMO;
        }
    ...
    public static class RelevantSkill {
        private String name;
        private String proficiency;

        public RelevantSkill() {
        }

        public RelevantSkill(String name, String proficiency) {
            this.name = name;
    ...
    public static class ApplicationForm {
        @JsonDeserialize(using = RelevantSkillsDeserializer.class)
        private List<RelevantSkill> relevantSkills;
        private String relevantExperience;
        private String availability;
        private String motivationCoverLetter;

        public List<RelevantSkill> getRelevantSkills() {
            return relevantSkills;
        }

        public void setRelevantSkills(List<RelevantSkill> relevantSkills) {
