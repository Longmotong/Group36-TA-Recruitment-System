...
public final class DashboardModuleIcons {
    ...
    private static final Color INK = JobsPortalUi.PRIMARY_PURPLE;
    private static final Color INK_SOFT = JobsPortalUi.MUTED_TEXT;
    private static final Color PAPER = JobsPortalUi.LAVENDER;
    private static final Color LINE = JobsPortalUi.LIGHT_PURPLE_BORDER;
    ...
    public static ImageIcon listManagement(int size) {
        ...
        g.setColor(JobsPortalUi.DEEP_PURPLE);
    ...
    public static ImageIcon documentReview(int size) {
        ...
        foldTri.closePath();
        g.setColor(JobsPortalUi.LIGHT_PURPLE_BORDER);
        g.fill(foldTri);
        g.setColor(LINE);
        g.draw(foldTri);
