...
public class JobDetailPanel extends JPanel {
    ...
    private JPanel statusPillHero(String normalized) {
        ...
        pill.setOpaque(true);
        pill.setFont(new Font(Font.SANS_SERIF, Font.BOLD, 14));
        pill.setBorder(new EmptyBorder(9, 16, 9, 16));
    ...
    private static void styleHeroActionButton(JButton button, int minWidth) {
        ...
        int w = Math.max(minWidth, pref.width + 14);
        int h = Math.max(42, pref.height + 8);
