...
import profile_module.ui.dashboard.DashboardUi;
...
/**
 * TA dashboard — centered layout, module cards, and quick overview stats.
...
public final class DashboardScreen extends JPanel {
    ...
    public DashboardScreen(AppFrame app) {
        ...
        setBackground(DashboardUi.palette().appBg());
    ...
    private JPanel buildCenter() {
        ...
        host.setBackground(DashboardUi.palette().appBg());
        host.add(DashboardUi.AppLayout.wrapCentered(buildDashboardRoot()), BorderLayout.CENTER);
        return host;
    }
    ...
    private JPanel buildDashboardRoot() {
        ...
        cards.setMaximumSize(new Dimension(DashboardUi.AppLayout.CONTENT_MAX_W, 420));
        final int iconPx = 40;
        cards.add(moduleCard(
                DashboardUi.DashboardModuleIcons.userProfile(iconPx),
        ...
        cards.add(moduleCard(
                DashboardUi.DashboardModuleIcons.briefcase(iconPx),
        ...
        root.setMaximumSize(new Dimension(DashboardUi.AppLayout.CONTENT_MAX_W, Integer.MAX_VALUE));
        return root;
    }
    ...
    private JPanel welcomeBanner() {
        ...
        banner.setMaximumSize(new Dimension(DashboardUi.AppLayout.CONTENT_MAX_W, 200));
        banner.setBackground(Color.WHITE);
        banner.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createCompoundBorder(
                        BorderFactory.createMatteBorder(0, 4, 0, 0, new Color(0x1A1A1A)),
                        BorderFactory.createLineBorder(DashboardUi.palette().border())
                ),
                new EmptyBorder(22, 24, 24, 24)
        ));

        JLabel title = new JLabel("TA Dashboard");
        title.setFont(DashboardUi.moFontBold(30));
    ...
    private JPanel moduleCard(Icon moduleIcon,
        ...
        t.setFont(DashboardUi.moFontBold(18));
        ...
        for (String b : bulletItems) {
            ...
            line.setFont(DashboardUi.moFontPlain(14));
        ...
        DashboardUi.RoundedActionButton primary = new DashboardUi.RoundedActionButton(primaryCta, DashboardUi.RoundedActionButton.Scheme.PRIMARY_BLACK);
        primary.setFont(DashboardUi.moFontBold(13));
        ...
        if (withSecondary && secondaryAction != null) {
            ...
            DashboardUi.styleSecondaryButton(secondary);
    ...
    private JPanel quickOverviewPanel() {
        ...
        outer.setMaximumSize(new Dimension(DashboardUi.AppLayout.CONTENT_MAX_W, 320));
        ...
        h.setFont(DashboardUi.moFontBold(17));
        ...
        completionValue.setFont(DashboardUi.moFontBold(34));
        completionValue.setForeground(statValue);
        cvStatusValue.setFont(DashboardUi.moFontBold(34));
        cvStatusValue.setForeground(statValue);
        appsValue.setFont(DashboardUi.moFontBold(34));
    ...
    private JPanel statBox(JLabel valueLabel, String caption, Color bg, Color border, Color valueColor) {
        ...
        cap.setFont(DashboardUi.moFontBold(12));
    ...
    public void refresh() {
        ...
        cvStatusValue.setFont(DashboardUi.moFontBold(cvText.length() > 8 ? 20 : 34));

        int appCount = app.profile().numberOfApplications;
