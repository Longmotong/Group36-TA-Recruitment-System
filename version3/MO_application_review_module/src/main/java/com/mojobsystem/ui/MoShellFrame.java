...
import com.mojobsystem.ui.job.CreateJobPanel;
import com.mojobsystem.ui.job.JobApplicantsIntegrationPlaceholderPanel;
import com.mojobsystem.ui.job.JobDetailPanel;
import com.mojobsystem.ui.job.MyJobsPanel;
import com.mojobsystem.ui.job.TaAllocationPanel;
...
public final class MoShellFrame extends JFrame implements MoShellHost {
    ...
    private void onMoSwitch() {
        ...
        } else if (CARD_REVIEW.equals(currentCard)) {
            reviewPanel.setFromJobId(applicationReviewFromJobId);
        }
    }
