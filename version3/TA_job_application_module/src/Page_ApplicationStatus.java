...
public class Page_ApplicationStatus {
    ...
    private JPanel buildOfferCard(Application app) {
        ...
        // Create a special highlighted card for offers
        JPanel card = new JPanel();
        card.setBackground(UI_Constants.CARD_BG);
        card.setBorder(BorderFactory.createCompoundBorder(
            BorderFactory.createLineBorder(UI_Constants.SUCCESS_COLOR, 2),
        ...
        // Use HTML for eye-catching heading with warning style
        JLabel heading = new JLabel("<html><body><span style='color: #DC2626; font-weight: bold;'>[!] ACTION REQUIRED</span> - Offer Received!</body></html>");
        ...
        // Use HTML for proper text wrapping with urgent styling
        JLabel hint = new JLabel("<html><body style='width: 380px; color: #374151;'>Congratulations! You have been offered the position of <b>" + jobTitle + "</b>. <span style='color: #DC2626;'><b>Please respond promptly</b></span> to confirm your acceptance.</body></html>");
        ...
        // Use GridBagLayout for buttons to ensure they don't overflow
        JPanel buttonPanel = new JPanel(new GridBagLayout());
        buttonPanel.setOpaque(false);
        GridBagConstraints btnConstraints = new GridBagConstraints();
        btnConstraints.insets = new Insets(0, 0, 0, 8);
        ...
        buttonPanel.add(declineBtn, btnConstraints);
        btnConstraints.gridx = 1;
        btnConstraints.insets = new Insets(0, 0, 0, 0);
        buttonPanel.add(acceptBtn, btnConstraints);
