...
public class DataService {
    ...
    private void saveApplicationToFile(Application app) {
        try {
            ...
            // Build JSON manually to ensure field order matches existing files
            com.google.gson.JsonObject root = new com.google.gson.JsonObject();
            root.addProperty("applicationId", app.getApplicationId());
            root.addProperty("userId", app.getUserId());
            root.addProperty("studentId", app.getStudentId());
            root.addProperty("jobId", app.getJobId());
            
            // jobSnapshot
            if (app.getJobSnapshot() != null) {
                root.add("jobSnapshot", jobSnapshotToJson(app.getJobSnapshot()));
            }
            
            // applicantSnapshot
            if (app.getApplicantSnapshot() != null) {
                root.add("applicantSnapshot", applicantSnapshotToJson(app.getApplicantSnapshot()));
            }
            
            // applicationForm
            if (app.getApplicationForm() != null) {
                root.add("applicationForm", applicationFormToJson(app.getApplicationForm()));
            }
            
            // attachments
            if (app.getAttachments() != null) {
                root.add("attachments", attachmentsToJson(app.getAttachments()));
            } else {
                root.add("attachments", new com.google.gson.JsonObject());
            }
            
            // workflow
            if (app.getWorkflow() != null) {
                root.add("workflow", workflowToJson(app.getWorkflow()));
            }
            
            // status
            if (app.getStatus() != null) {
                root.add("status", statusToJson(app.getStatus()));
            }
            
            // review
            if (app.getReview() != null) {
                root.add("review", reviewToJson(app.getReview()));
            }
            
            // timeline
            if (app.getTimeline() != null) {
                root.add("timeline", timelineToJson(app.getTimeline()));
            }
            
            // meta
            if (app.getMeta() != null) {
                root.add("meta", metaToJson(app.getMeta()));
            }
            
            // isDraft at the end
            root.addProperty("isDraft", app.isDraft());
    ...
    private com.google.gson.JsonObject jobSnapshotToJson(Application.JobSnapshot js) {
        com.google.gson.JsonObject o = new com.google.gson.JsonObject();
        o.addProperty("title", js.getTitle());
        o.addProperty("courseCode", js.getCourseCode());
        o.addProperty("courseName", js.getCourseName());
        o.addProperty("department", js.getDepartment());
        o.addProperty("instructorName", js.getInstructorName());
        o.addProperty("instructorEmail", js.getInstructorEmail());
        o.addProperty("deadline", js.getDeadline());
        o.addProperty("employmentType", js.getEmploymentType());
        o.addProperty("weeklyHours", js.getWeeklyHours());
        o.addProperty("locationMode", js.getLocationMode());
        o.addProperty("locationDetail", js.getLocationDetail());
        return o;
    }
    
    private com.google.gson.JsonObject applicantSnapshotToJson(Application.ApplicantSnapshot as) {
        com.google.gson.JsonObject o = new com.google.gson.JsonObject();
        o.addProperty("fullName", as.getFullName());
        o.addProperty("studentId", as.getStudentId());
        o.addProperty("email", as.getEmail());
    ...
    private com.google.gson.JsonObject applicationFormToJson(Application.ApplicationForm af) {
        com.google.gson.JsonObject o = new com.google.gson.JsonObject();
        com.google.gson.JsonArray skillsArr = new com.google.gson.JsonArray();
        if (af.getRelevantSkills() != null) {
            for (String s : af.getRelevantSkills()) {
                skillsArr.add(s);
            }
        }
        o.add("relevantSkills", skillsArr);
        o.addProperty("relevantExperience", af.getRelevantExperience());
        o.addProperty("availability", af.getAvailability());
        o.addProperty("motivationCoverLetter", af.getMotivationCoverLetter());
        return o;
    }
    
    private com.google.gson.JsonObject attachmentsToJson(Application.Attachments at) {
        com.google.gson.JsonObject o = new com.google.gson.JsonObject();
        if (at.getCv() != null) {
        ...
        if (at.getSupportingDocuments() != null && !at.getSupportingDocuments().isEmpty()) {
            ...
            o.add("supportingDocuments", docs);
        }
        return o;
    }
    
    private com.google.gson.JsonObject workflowToJson(Application.Workflow wf) {
        com.google.gson.JsonObject o = new com.google.gson.JsonObject();
    ...
    private com.google.gson.JsonObject statusToJson(Application.Status s) {
        com.google.gson.JsonObject o = new com.google.gson.JsonObject();
    ...
    private com.google.gson.JsonArray timelineToJson(List<Application.TimelineEvent> timeline) {
        com.google.gson.JsonArray arr = new com.google.gson.JsonArray();
        if (timeline == null) return arr;
        for (Application.TimelineEvent ev : timeline) {
            com.google.gson.JsonObject o = new com.google.gson.JsonObject();
            o.addProperty("timelineId", ev.getTimelineId());
            o.addProperty("stepKey", ev.getStepKey());
    ...
    private com.google.gson.JsonObject metaToJson(Application.Meta m) {
        com.google.gson.JsonObject o = new com.google.gson.JsonObject();
        o.addProperty("submittedAt", m.getSubmittedAt());
        o.addProperty("updatedAt", m.getUpdatedAt());
        o.addProperty("isDeleted", m.isIsDeleted());
        return o;
    }
    ...
    public boolean acceptOffer(String applicationId) {
        Application app = getApplicationById(applicationId);
        if (app == null) {
            return false;
        }
        ...
        app.getReview().setStatusMessage("You have accepted this TA position. Congratulations!");
        app.getReview().setNextSteps("Please wait for further instructions from the course instructor.");
        app.getReview().setReviewedBy(currentUser.getUserId());
        app.getReview().setReviewedAt(LocalDateTime.now().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME));
        ...
        Application.TimelineEvent ev = new Application.TimelineEvent();
        ev.setTimelineId("tl_" + System.currentTimeMillis());
        ev.setStepKey("offer_accepted");
        ev.setStepLabel("Offer Accepted");
        ev.setStatus("completed");
        ev.setTimestamp(LocalDateTime.now().format(DateTimeFormatter.ISO_LOCAL_DATE_TIME));
        ev.setNote("You accepted the TA offer.");
        timeline.add(ev);
