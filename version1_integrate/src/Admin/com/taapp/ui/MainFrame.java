...
public class MainFrame extends JFrame {
    ...
    /** When non-null, Logout returns to integrated login instead of showing the standalone demo message. */
    ...
    public MainFrame(Runnable afterLogout) {
        super("Admin System");
        this.afterLogout = afterLogout;

        setDefaultCloseOperation(afterLogout != null ? DISPOSE_ON_CLOSE : EXIT_ON_CLOSE);
