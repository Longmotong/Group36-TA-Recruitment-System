...
public final class ProfileScreen extends JPanel {
    ...
    public ProfileScreen(TaPortalHost host) {
        this.host = host;
    ...
    private JPanel buildBody() {
        ...
        head.add(navLink("← Back to Home", host::showDashboard));
    ...
    private JPanel buildPersonalCard() {
        ...
        card.add(cardHeader("Personal Information", "Edit Profile", () -> host.showRoute(TaPortalHost.ROUTE_EDIT_PROFILE)), BorderLayout.NORTH);
    ...
    private JPanel buildSkillsCard() {
        ...
        card.setLayout(new BorderLayout());
        card.setBorder(Ui.empty(16, 16, 16, 16));
        card.add(cardHeader("Skills Information", "Edit Skills", () -> host.showRoute(TaPortalHost.ROUTE_EDIT_SKILLS)), BorderLayout.NORTH);
    ...
    private JPanel buildCvCard() {
        ...
        card.setLayout(new BorderLayout());
        card.setBorder(Ui.empty(16, 16, 16, 16));
        card.add(cardHeader("CV Information", "Manage CV", () -> host.showRoute(TaPortalHost.ROUTE_MANAGE_CV)), BorderLayout.NORTH);
        ...
        JPanel cvWrap = new JPanel(new BorderLayout());
        cvWrap.setOpaque(false);
        cvWrap.setBorder(Ui.empty(12, 0, 0, 0));
        cvWrap.add(line, BorderLayout.CENTER);
        card.add(cvWrap, BorderLayout.CENTER);
        return card;
    }
