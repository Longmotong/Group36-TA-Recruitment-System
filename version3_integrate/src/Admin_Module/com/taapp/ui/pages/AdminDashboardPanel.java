...
public class AdminDashboardPanel extends Page {
    ...
    private JPanel welcomeBanner() {
        ...
        JLabel sub = new JLabel("<html><div style='width:720px;line-height:1.5'>"
                + "<span style='color:#525252;font-size:15px;font-family:sans-serif'>Open a module to review live workload and statistics data from the JSON records.</span></div></html>");
    ...
    private JPanel moduleCard(String iconText,
        ...
        ic.setForeground(new Color(0x374151));
